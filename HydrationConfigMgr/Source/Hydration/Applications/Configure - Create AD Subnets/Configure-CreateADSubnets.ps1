...
New-ADReplicationSite -Name NewYork
New-ADReplicationSite -Name Stockholm
New-ADReplicationSite -Name Liverpool

# Create AD Subnets
New-ADReplicationSubnet -Name "192.168.21.0/24" -Site NewYork
New-ADReplicationSubnet -Name "192.168.22.0/24" -Site Stockholm
New-ADReplicationSubnet -Name "192.168.23.0/24" -Site Liverpool
