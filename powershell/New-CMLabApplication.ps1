...
Add-CMDeploymentType -ApplicationName $Application.LocalizedDisplayName `
  ...
  -InstallationFileLocation '\\CM01\Sources\Software\Paint.NET\4.0.9\x64\PaintDotNet.x64.msi' `
  -MsiInstaller `
  -DeploymentTypeName 'Paint.NET 4.0.9 (x64) - Windows Installer (*.msi file)'
...
Add-CMDeploymentType -ApplicationName $Application.LocalizedDisplayName `
  -AutoIdentifyFromInstallationFile `
  -ForceForUnknownPublisher $true `
  -InstallationFileLocation '\\CM01\Sources\Software\Paint.NET\4.0.9\x86\PaintDotNet.x86.msi' `
  -MsiInstaller `
  -DeploymentTypeName 'Paint.NET 4.0.9 (x86) - Windows Installer (*.msi file)'
